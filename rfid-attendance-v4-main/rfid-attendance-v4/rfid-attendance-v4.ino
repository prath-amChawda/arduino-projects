...
const char *GScriptId = "AKfycbzGCNcVTtiZJih1d92kC07oc4wrbUYnPGBZE0S28972TFbmP6w93HB4vDETusx5yzrUyg";
String gate_number = "Gate1";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "Robotechzone";
const char* password = "samay700";
//---------------------------------------------------------------------------------------------------------
